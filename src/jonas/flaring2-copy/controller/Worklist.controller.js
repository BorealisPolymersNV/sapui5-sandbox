sap.ui.define([
  ...
  return BaseController.extend("myCompany.myApp.controller.Worklist", {
     ...
     */
    onInit: function () {
      debug('Worklist.contoller.js:onInit');
      ...
      //this._showFormFragment("Event", false, "eventData");
    },
     ...
     * @public
     */
    onUpdateEventFinished: function(oEvent){ return this.onUpdateFinished(oEvent);},
    onUpdateFinished: function (oEvent) {
      debug('onUpdateFinished');
    ...
    onPress: function (oEvent) {
      debug('onPress', oEvent.getSource().getId(), oEvent.getSource());
