sap.ui.define([
  ...
  return BaseObject.extend("masterdetail.model.ListSelector", {
    ...
    constructor: function () {
      console.debug('ListSelector.js:constructor');
    ...
    // Tries to select and scroll to a list item with a matching binding context. If there are no items 
    // matching the binding context or the ListMode is none, no selection/scrolling will happen
    // @param {string} sBindingPath the binding path matching the binding path of a list item
    selectAListItem: function (sBindingPath) {
      console.debug('ListSelector.js:selectAListItem');
    ...
    detachListSelectionChange: function (fnFunction, oListener) {
      console.debug('ListSelector.js:detachListSelectionChange');
    ...
    clearMasterListSelection: function () {
      console.debug('ListSelector.js:clearMasterListSelection');
